  ...
  visitingVisas: [
    {
      ...
      summary: 'The standard tourist/visitor visa most African travellers need to enter Canada for a holiday, family visit, or short business trip.',
      ...
      cost: '~$100 CAD, plus ~$85 CAD biometrics fee',
      ...
      leadsToPR: 'no',
      status: 'open',
      statusNote: 'Typically valid for up to 10 years (or until your passport expires) with multiple entries, each stay capped at 6 months. It does not automatically convert to another status — you would need to apply for a study/work permit or PR pathway separately from within or outside Canada.',
    },
    {
      name: 'Electronic Travel Authorization (eTA)',
      summary: "A cheaper, lighter-touch alternative to the TRV — but only available to citizens of a short list of visa-exempt countries, which excludes most African nationalities.",
      eligibility: ['Citizen of a visa-exempt country', 'Valid passport', 'Travelling by air'],
      cost: '~$7 CAD',
      timeline: 'Usually minutes to a few days via the online form',
      documents: ['Passport', 'Credit/debit card for the fee', 'Email address'],
      leadsToPR: 'no',
      status: 'open',
      statusNote: 'Most African passport holders are not on the visa-exempt list and will need the TRV above instead.',
    },
  ],
  careerPathways: [
    {
